<template>
    ...
    <ShareFilesModal v-model:modalValue="showEmailsModal" :all-selected="allSelected" :selected-ids="selectedIds"/>
</template>
...
function onClick() {
    if (!props.allSelected && !props.selectedIds.length) {
        showErrorDialog('Please select al least one file to share');
        return;
    }
