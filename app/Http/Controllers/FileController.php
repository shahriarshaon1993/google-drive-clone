...
class FileController extends Controller
{
    ...
    public function destroy(FilesActionsRequest $request)
    {
        $data = $request->validated();
        $parent = $request->parent;
    ...
    public function download(FilesActionsRequest $request)
    {
        $data = $request->validated();
        $parent = $request->parent;
    ...
    public function deleteFroever(TrashFileRequest $request)
    {
        $data = $request->validated();
        if ($data['all']) {
            $children = File::onlyTrashed()->get();
    ...
    public function downloadSharedWithMe(FilesActionsRequest $request)
    {
        $data = $request->validated();
    ...
    public function downloadSharedByMe(FilesActionsRequest $request)
    {
        $data = $request->validated();
